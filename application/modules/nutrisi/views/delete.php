    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Hapus Data Nutrisi</h4>
            </div>
            <div class="modal-body">
                <p class="alert alert-danger"><i class="fa fa-warning"></i> Yakin ingin menghapus data ini </p>
            </div>
            <div class="modal-footer">
                <a href="<?php echo base_url('nutrisi/delete/'.$data->id) ?> " class="btn btn-danger"><i class="fa fa-trash-o"></i> Hapus Data</a>
                <a href="<?php echo base_url('nutrisi/update/'.$data->id) ?> " class="btn btn-warning"><i class="fa fa-edit"></i> Update Data</a>
